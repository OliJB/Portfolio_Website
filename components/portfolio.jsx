...
const portfolio = async () => {
  ...
  return (
   <>
   <div className="w-full px-4 sm:px-12 md:px-24 lg:px-36 xl:px-56 flex flex-col items-center h-fit mb-16">
              ...
              <div className="flex flex-col w-full items-center text-center py-10 p-5 md:pr-10 md:items-start md:w-2/3 md:text-left">
                ...
                <div className="flex flex-wrap mt-auto">
                  {project.languages.map((language) => (
                    <div className="border-2 rounded-md border-slate-600 mr-4 mb-2 py-1 px-2 font-montserrat " key={language}>{language}</div>
                  ))}
                </div>
              </div>
         		</div>
